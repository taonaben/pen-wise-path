...
export function DashboardFilterBar({ filters, species, pens, onFiltersChange }: Props) {
  return (
    <div className="grid grid-cols-1 gap-3 rounded-2xl border bg-farm-800/70 p-3 sm:grid-cols-2 sm:p-4 xl:grid-cols-4">
      <label className="space-y-1 text-xs sm:text-sm">
        <span className="text-farm-muted">Start Date</span>
        <input
          type="date"
          className="h-9 w-full rounded-lg border border-farm-600/40 bg-farm-900/60 px-3 text-sm sm:h-10"
